...
function get_home_url( $blog_id = null, $path = '', $scheme = null ) {
	// og
	// Set the default scheme to HTTPS. If we don't change the scheme here
	// it's going to be taken from the home site URL that is stored in the database. 
	// The home site URL cannot be changed without changing it in the database 
	// (because were using multisite). Since the home URL is HTTP, the resulting scheme 
	// will be set to HTTP, which will cause issues when trying to use SSL and HTTPS
	// (e.g. random links and resources will be HTTP instead of HTTPS. As a result some 
	// ajax request will fail and some resources will not load). This code solves this 
	// problem. NOTE: make sure to change this or revert these changes when using HTTP.   
	$scheme = 'https';
	// end og
	$orig_scheme = $scheme;

	//  error_log("og ssl test original scheme: ".$scheme);
	...
	//error_log("og ssl test original url: ".$url);
	...
	//error_log("og ssl test ". $url." scheme: ".$scheme." serverhttps: ".$_SERVER['HTTPS']. " isssl: ".is_ssl());
