...
function bbp_forum_subscription_link( $args = array() ) {
	 ...
	 */
	function bbp_get_forum_subscription_link( $args = array(), $user_id = 0, $wrap = true ) {
		...
		if ( ! bbp_is_forum_category() ) {
			//error_log("og forum_subs".$user_id);
			//error_log("og forum_subs r".print_r($r,true));
			$retval = bbp_get_user_subscribe_link( $r, $user_id, $wrap );
		}
