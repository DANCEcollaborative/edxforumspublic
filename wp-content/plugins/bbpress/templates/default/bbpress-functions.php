...
class BBP_Default extends BBP_Theme_Compat {
	...
	private function setup_actions() {
		...
		add_action( 'bbp_ajax_getfavoritestate',           array( $this, 'ajax_get_favorite'           ) ); // Gets the topic ajax favorite/unfavorite
                add_action( 'bbp_ajax_getsubscriptionstate',       array( $this, 'ajax_get_subscription'       ) ); // Gets the topic ajax subscribe/unsubscribe
		add_action( 'bbp_ajax_forum_getsubscriptionstate', array( $this, 'ajax_get_forum_subscription' ) ); // Handles the forum ajax subscribe/unsubscribe
	}
	...
	public function enqueue_scripts() {
		...
		if ( bbp_use_wp_editor() ) {
			error_log("og is single editor ".bbp_get_topic_post_type()." query: ".bbp_get_query_name()." is singular: ".is_singular(bbp_get_topic_post_type()));
