...
// og start
// Replace http://<domainname> with https://<domainname>
function og_my_change_links_to_https(&$myitem,$mykey){
	if($mykey=="url"){
		$ogvarmydomain = $_SERVER['SERVER_NAME'];
		$myitem = str_replace("http://".$ogvarmydomain,"https://".$ogvarmydomain,$myitem);
	}
}
// og end
...
function wp_ajax_query_attachments() {
	...
	//error_log(" og attachments: ".print_r($posts,true));
	
	// og added: replace http with https so we can load media images in https
	array_walk_recursive($posts, 'og_my_change_links_to_https');
